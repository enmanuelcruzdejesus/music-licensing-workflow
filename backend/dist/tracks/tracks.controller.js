...
let TracksController = class TracksController {
    ...
    create(sceneId, payload) {
        return this.tracksService.create(sceneId, payload);
    }
    findByScene(sceneId, pagination) {
...
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Param)("sceneId", new common_1.ParseUUIDPipe({ version: "4" }))),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TracksController.prototype, "findByScene", null);
exports.TracksController = TracksController = __decorate([
    (0, common_1.Controller)("scenes/:sceneId/tracks"),
