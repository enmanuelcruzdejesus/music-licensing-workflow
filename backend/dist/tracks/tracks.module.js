...
const tracks_events_controller_1 = require("./tracks-events.controller");
...
exports.TracksModule = TracksModule = __decorate([
    (0, common_1.Module)({
        controllers: [tracks_controller_1.TracksController, tracks_events_controller_1.TracksEventsController],
